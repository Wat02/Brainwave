    ...
    id="hero">
      <div className="container relative">
        <div className="relative z-1 max-w-[62rem] mx-auto text-center mb-[3.875rem] md:mb-20 lg:mb-[6.25rem]">
          ...
          <button className="bg-[#FFFFFF] pt-[10px] pb-[10px] pl-[30px] pr-[30px] text-black rounded-md">Get started</button>
        </div>
        <div className="relative max-w-[23rem] mx-auto md:max-w-5xl xl:mb-24">
          ...
          <div className="absolute -top-[54%] left-1/2 -translate-x-1/2 md:-top-[46%] md:w-[100%] lg:-top-[104%]">
            <Image
              src={heroBackground}
